...
def change_color(surface, color):
    ...
    for x in range(w):
        for y in range(h):
            ...
            if (surface.get_at((x, y))[0] != 0): surface.set_at((x, y), pygame.Color(r, g, b, a))
...
pygame.draw.line(square, (0, 0, 0), (0, square_height - 1), (square_width - 1, square_height - 1))
pygame.draw.line(square, (0, 0, 0), (square_width - 1, 0), (square_width - 1, square_height - 1))
pygame.draw.line(square, (0, 0, 0), (38.05, 0), (38.05, square_height))
pygame.draw.line(square, (0, 0, 0), (38.05 + 39, 0), (38.05 + 39, square_height))
pygame.draw.line(square, (0, 0, 0), (38.05 + 39*2, 0), (38.05 + 39*2, square_height))
pygame.draw.line(square, (0, 0, 0), (38.05 + 39*3, 0), (38.05 + 39*3, square_height))
while is_running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT or (event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE):
            ...
            pygame.quit()
            sys.exit()
        if event.type == pygame.MOUSEBUTTONDOWN and not within(event.pos[0], event.pos[1], x, y, square_width, square_height):
            dragable = False
    ...
    for row in range(20):
        for col in range(20):
            pygame.draw.rect(screen, (200, 200, 200),pygame.Rect(110 + col * 39, 110 + row * 39, 38.05, 38.05))
